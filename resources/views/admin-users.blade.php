            ...
            <tbody>
              ...
              <tr class="data-item">
                   <td>{{$key+1}}</td>
                    ...
                    <td class="data-col dt-account"><span class="lead user-info">{{$d->btc_wallet}}</span>
                    </td>
                    <td class="data-col dt-type"><span class="dt-type-md badge badge-outline badge-success badge-md">{{$d->created_at->format('d M, Y h:i A')}}</span>
