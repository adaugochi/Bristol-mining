...
<div class="content-wrapper">
    ...
    <div class="row">
       <div class="col-lg-12 table-responsive">
        ...
        <table class="table table-stiped">
            ...
            <tbody>
              ...
              <tr class="data-item">
                    ...
                    <td class="data-col dt-token"><span class="lead token-amount">{{strtoupper($d->user->name)}} <br><br>{{number_format($d->amount, 2, '.', ',')}} $ </span>
                    </td>
        ...
        <p class="text-danger">Note that you RIO start counting from the day of payment approval</p>
        {{$deposits->links()}}
    </div>
    </div>
</div>
